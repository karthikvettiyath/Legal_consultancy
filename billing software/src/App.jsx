...
// Mock hook since we aren't installing react-to-print yet? 
// Wait, I didn't install react-to-print. I should use window.print() or install it.
// Plan said "react-to-print (Optional, or just native window.print())".
// Native window.print() works well if we hide sidebar with css media query.
// But useReactToPrint is cleaner for specific component printing.
// I will just use native print for now with @media print styles to hide sidebar.

function App() {
  const [data, setData] = useState({
    type: 'INVOICE', // 'INVOICE' or 'QUOTATION'
    clientName: 'CLUSTER MEDICAL CENTRE',
